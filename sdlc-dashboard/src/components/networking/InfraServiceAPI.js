...
const networkPlansURL = baseURL + "/network-plans";
const networkPlans = async () => {
    const response = await axios.get(networkPlansURL, { withCredentials: true });
    return response;
};

export { networkPlans, ipv4NetworkReferenceData_privateCidrBlocks, ipv4NetworkReferenceData_prefixLengths }